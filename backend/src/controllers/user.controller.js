...
export async function declineFriendRequest(req, res) {
  try {
    ...
    console.log(`Decline request received. requestId=${requestId}, user=${req.user?._id}`);
    ...
    // Verify the current user is the recipient (only recipient can decline)
    if (friendRequest.recipient.toString() !== req.user.id) {
      console.log(`Unauthorized decline attempt: recipient=${friendRequest.recipient.toString()} user=${req.user.id}`);
